...
public class UIDefending : MonoBehaviour
{
    ...
    {
        m_fireIncome.text = m_player.elementBuffDict[ ElementType.Fire ].ToString000();
        m_waterIncome.text = m_player.elementBuffDict[ ElementType.Water ].ToString000();
        m_windIncome.text = m_player.elementBuffDict[ ElementType.Wind ].ToString000();
        m_dirtIncome.text = m_player.elementBuffDict[ ElementType.Dirt ].ToString000();
    }
